...
<template>
    <BaseModal :open="open" @update:open="val => emit('update:open', val)" maxWidth="lg" :closeOnBackdrop="true"
        labelledby="cat-picker-title">
        <template #header>
            <div class="flex items-center gap-2">
                ...
                <h3 id="cat-picker-title" class="font-heading text-lg">
